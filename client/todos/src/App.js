...
function App() {
  ...
  const addItem = async (e) => {
    ...
    try {
      ...
      const res = await axios.post("https://mern-app-stacks-apis.onrender.com", { item: itemText,numb:number})
      console.log(res);
    }
    catch (err) {
      console.log(err)
  ...
  useEffect(() => {
    const getItem = async () => {
      try {
        const res = await axios.get('https://mern-app-stacks-apis.onrender.com')
